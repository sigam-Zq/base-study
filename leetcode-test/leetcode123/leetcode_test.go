...
func TestXxx(t *testing.T) {
	// t1 := divideArray([]int{1, 3, 4, 8, 7, 9, 3, 5, 1}, 2)

	// t.Log(t1)

	// t2 := divideArray([]int{4, 2, 9, 8, 2, 12, 7, 12, 10, 5, 8, 5, 5, 7, 9, 2, 5, 11}, 14)
	// t.Log(t2)
	t3 := divideArray([]int{2, 4, 2, 2, 5, 2}, 2)
...
func divideArrayLeetCode(nums []int, k int) [][]int {
	sort.Ints(nums)
	res := [][]int{}
...
// 作者：力扣官方题解
// 链接：https://leetcode.cn/problems/divide-array-into-arrays-with-max-difference/solutions/3686280/hua-fen-shu-zu-bing-man-zu-zui-da-chai-x-3iet/
// 来源：力扣（LeetCode）
